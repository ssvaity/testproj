...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        display: ['Marcellus', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'Noto Serif', 'serif'],
        'headline-md': ['Marcellus', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'Noto Serif', 'serif'],
        'headline-lg': ['Marcellus', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'Noto Serif', 'serif'],
        'headline-lg-mobile': ['Marcellus', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'Noto Serif', 'serif'],
        'headline-xl': ['Marcellus', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'Noto Serif', 'serif'],
        'body-md': ['Noto Serif', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'serif'],
        'body-lg': ['Noto Serif', 'Noto Serif Devanagari', 'Noto Serif Gujarati', 'serif'],
        'label-md': ['Noto Sans', 'Noto Sans Devanagari', 'sans-serif'],
      ...
      fontSize: {
        ...
        'headline-md': ['23px', { lineHeight: '30px', fontWeight: '400', letterSpacing: '0.01em' }],
        ...
        'headline-xl': ['52px', { lineHeight: '58px', letterSpacing: '0.005em', fontWeight: '400' }],
        'label-md': ['13px', { lineHeight: '18px', letterSpacing: '0.14em', fontWeight: '600' }],
      },
    },
  },
  plugins: [forms],
